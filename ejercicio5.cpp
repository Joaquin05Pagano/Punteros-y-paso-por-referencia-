/*hay que definir las columnas y filas de 2 matrices y luego darle los valores a cada una,
luego el programa te muestra las matrices y el producto de ambas*/
