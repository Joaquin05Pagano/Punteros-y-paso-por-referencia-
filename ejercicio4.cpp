//devuelve los valores que se ingresan previamente, pero de forma vertical y horizontal. aunque este tambien ordena verticalmente, pero ordenado de mayor a menor
#include <stdio.h>
